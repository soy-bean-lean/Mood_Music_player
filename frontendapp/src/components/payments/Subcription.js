               ...
               >
                ...
                <form action="https://uat.esewa.com.np/epay/main" method="POST">
                    ...
                    <div className="form-group">
                      ...
                      <input value={(subcription==="monthly")?100:300} className="form-control" id="exampleInputttAmt" aria-describedby="ttAmtHelp" name="totalAmount" type="text" disabled/>
                      <input value={(subcription==="monthly")?100:300} className="form-control" id="exampleInputtAmt" aria-describedby="tAmtHelp" name="tAmt" type="hidden" />
                    </div>


                    <div className="form-group">
                      <label htmlFor="exampleInputamt">Amount</label>
                      <input value={(subcription==="monthly")?100:300} className="form-control" id="exampleInpuAmt" aria-describedby="mtHelp" name="Amount" type="text" disabled/>
                      <input value={(subcription==="monthly")?100:300} className="form-control" id="exampleInpuAmt" aria-describedby="tAmtHelp" name="amt" type="hidden" />
                    </div>
